var Quiz1Fail = (function (game) {
    ...
    return {
        ...
        create: function () {
            ...
            Helper.addSmallTitle("Đáp án của bạn chưa chính xác!", 0);
            ...
            if (game.userChoice === CONFIG.TYPE1) {
                Helper.addMan(game.world.centerX - 400, game.world.height - 300, 'sadman1');
            } else {
                Helper.addMan(game.world.centerX + 400, game.world.height - 300, 'sadman2');
            }
