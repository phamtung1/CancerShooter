var Quiz2Fail = (function (game) {
    ...
    return {
        ...
        create: function () {
            ...
            Helper.addSmallTitle("Đáp án của bạn chưa chính xác!", 1);
            ...
            if (game.userChoice === CONFIG.TYPE1) {
                ...
                Helper.addMan(game.world.centerX - 400, game.world.height - 150, 'sadman1', 0.7);
            } else {
                text = game.add.text(game.world.centerX, game.world.height - 150, "c. Tất cả các ý trên", CONFIG.answerFontStyle);

                Helper.addMan(game.world.centerX + 400, game.world.height - 150, 'sadman2', 0.7);
            }
            text.anchor.set(0.5);
